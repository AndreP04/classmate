    ...
    return (
        <form className="bg-[#f5f5f6]">
            <div className="w-full flex justify-between items-center mb-3 mt-1 pl-3">
                <div>
                    <h3 className="text-lg font-semibold text-slate-800">Educators</h3>
                </div>
                <div className="ml-3">
            ...
            </div><div className="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
                    ...
                    <tbody>
                        <tr className="hover:bg-slate-50 border-b border-slate-200">
                            <td className="p-4 py-5">
                                <p className="block text-sm text-slate-800">Pieter</p>
                            </td>
                            <td className="p-4 py-5">
                                <p className="text-sm text-slate-800">Roux</p>
                            </td>
                            <td className="p-4 py-5">
                                <p className="text-sm text-slate-800">pieterroux@gmail.com</p>
                            </td>
                        </tr>
                        <tr className="hover:bg-slate-50 border-b border-slate-200">
                            <td className="p-4 py-5">
                                <p className="block text-sm text-slate-800">Helena</p>
                            </td>
                            <td className="p-4 py-5">
                                <p className="text-sm text-slate-800">Pieterse</p>
                            </td>
                            <td className="p-4 py-5">
                                <p className="text-sm text-slate-800">helenapieterse87@icloud.com</p>
                            </td>
