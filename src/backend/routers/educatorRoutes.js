import { addStudent, modifyStudent, removeStudent, search, allStudents } from "../controllers/educatorController.js";
...
educatorRouter.put("/edit-student", requireAuth, modifyStudent);
